...
inquiry_options() {
  ...
  print_banner
  printf "${WHITE} 💻 Bem vindo(a) ao Gerenciador WCM Digital SaaS, selecione abaixo a proxima ação!${GRAY_LIGHT}"
  printf "\n\n"
  printf "   [0] Instalar WCM Digital SaaS\n"
  printf "   [1] Atualizar WCM Digital SaaS\n"
  printf "   [2] Deletar WCM Digital SaaS\n"
  printf "   [3] Bloquear WCM Digital SaaS\n"
  printf "   [4] Desbloquear WCM Digital SaaS\n"
  printf "   [5] Alter. dominio WCM Digital SaaS\n"
  printf "\n"
  read -p "> " option
